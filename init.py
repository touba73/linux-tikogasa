...
config_path="liquorix-package-5.18-13/linux-liquorix/debian/config/kernelarch-x86/config-arch-64"
patch_path="liquorix-package-5.18-13/linux-liquorix/debian/patches/zen/v5.18.12-lqx1.patch"
f = open("delete.txt","r") 
