...
config_path="liquorix-package-5.18-3/linux-liquorix/debian/config/kernelarch-x86/config-arch-64"
patch_path="liquorix-package-5.18-3/linux-liquorix/debian/patches/zen/v5.18.7-lqx1.patch"
f = open("delete.txt","r") 
